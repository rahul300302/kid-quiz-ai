...
exports.MetricsModule = MetricsModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: performance_metrics_schema_1.PerformanceMetrics.name, schema: performance_metrics_schema_1.PerformanceMetricsSchema }])
        ],
